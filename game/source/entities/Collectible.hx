...
class Collectible extends FlxGroup
{
	...
	public static inline var TYPE_THROW:Int = 3;
	public static inline var TYPE_KICK:Int = 4;
	public static inline var TYPE_PUNCH:Int = 5;
	public static inline var TYPE_MAXPOWER:Int = 6;
	public static inline var TYPE_MAX:Int = 6;
